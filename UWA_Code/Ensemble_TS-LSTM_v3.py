...
myKeepProb = 0.3
myHiddenSize = 50
view_subject = 'Ensemble TS-LSTM v3'
...
class TS_Long_LSTM_Top(object):
    ...
    def __init__(self, is_training, config, labels, top_input_data, top_targets, top_hidden_size):
        ...
        with tf.device(sw_0):
            ...
            num_LSTMs_0 = len(range(0, num_steps - win_size[0] + start_time[0], stride[0]))
            num_LSTMs_1 = len(range(0, num_steps - win_size[1] + start_time[1], stride[1]))
            num_LSTMs_2 = len(range(0, num_steps - win_size[2] + start_time[2], stride[2]))
...
class TS_Medium_LSTM_Top(object):
    def __init__(self, is_training, config, labels, top_input_data, top_targets, top_hidden_size):
        ...
        with tf.device(sw_0):
            ...
            num_LSTMs_3 = len(range(0, num_steps - win_size[3] + start_time[3], stride[3]))
            num_LSTMs_4 = len(range(0, num_steps - win_size[4] + start_time[4], stride[4]))
...
class TS_Short_LSTM_Top(object):
    def __init__(self, is_training, config, labels, top_input_data, top_targets, top_hidden_size):
        ...
        with tf.device(sw_0):
            ...
            num_LSTMs_5 = len(range(0, num_steps - win_size[5] + start_time[5], stride[5]))
                    ...
                    if time_step < win_step * stride_3:
                        ...
                        if time_step < start_time_3 + win_step * stride_3:
                            ...
                            if start_time_3 == 1:
                                ...
                                distance = tf.reduce_sum(inputs[:, time_step - start_time_3:time_step + 1, :], 1) / (
                                start_time_3 + 1)
                    ...
                    if time_step < win_step * stride_4:
                        ...
                        if time_step < start_time_4 + win_step * stride_4:
                            ...
                            if start_time_4 == 1:
                                ...
                                distance = tf.reduce_sum(inputs[:, time_step - start_time_4:time_step + 1, :], 1) / (
                                start_time_4 + 1)
...
class TS_LSTM_Short_5(object):
    def __init__(self, is_training, config, input_data):
        ...
        num_LSTMs_5 = len(
            range(0, num_steps - win_size_5 + start_time_5, stride_5))  # range ( start, end, delta), len = 5
                    ...
                    if time_step < win_step * stride_5:
                        ...
                        if time_step < start_time_5 + win_step * stride_5:
                            ...
                            if start_time_5 == 1:
                                ...
                                distance = tf.reduce_sum(inputs[:, time_step - start_time_5:time_step + 1, :], 1) / (
                                start_time_5 + 1)
...
def main(_):
    ...
    test_sklt12 = feature_only_diff_0(test_sklt02, MAX_LENGTH, eval_config2)
    ...
    test_sklt22 = Human_Cognitive_Coordinate(test_sklt12)

    feature_train = Pose_Motion(train_sklt2)
    feature_test = Pose_Motion(test_sklt2)
    feature_test2 = Pose_Motion(test_sklt22)
    ...
    del train_sklt2, test_sklt2, test_sklt22
