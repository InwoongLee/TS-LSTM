...
# win_size_data = [120, 120, 120,
#                  150,
#                  180, 180, 180,
#                  210,
#                  240, 240, 240,
#                  270, 270, 270]
# stride_data = [60, 60, 60,
#                150,
#                120, 120, 120,
#                90,
#                60, 60, 60,
#                30, 30, 30]
# start_time_data = [2, 5, 7,
#                    6,
#                    4, 5, 7,
#                    8,
#                    2, 6, 8,
...
folder_path = 'Generalized_TS-LSTM_subject'
...
def main(_):
    ...
    eval_config.batch_size = len(feature_test) / 4
    ...
    with tf.Graph().as_default(), tf.Session(config=sessConfig) as session:
        with tf.device('/cpu:0'):
            ...
            saver.restore(session, "./TrialSaver/Generalized_TS-LSTM_subject/20180505_1449_BD_90_KB_0.40_NP_25_NS_01/NTU_subject.ckpt-1100")
