...
for i=1:size(confusion_WS_021,1)    
    confusion_WS_021(i,31) = confusion_WS_021(i,mod(i-1,30)+1)/sum(confusion_WS_021(i,1:30))*100;
end
 
class_acc_WS_021 = reshape(confusion_WS_021(:,31),30,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_042,1)    
    confusion_WS_042(i,31) = confusion_WS_042(i,mod(i-1,30)+1)/sum(confusion_WS_042(i,1:30))*100;
end
 
class_acc_WS_042 = reshape(confusion_WS_042(:,31),30,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_063,1)    
    confusion_WS_063(i,31) = confusion_WS_063(i,mod(i-1,30)+1)/sum(confusion_WS_063(i,1:30))*100;
end
 
class_acc_WS_063 = reshape(confusion_WS_063(:,31),30,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_084,1)    
    confusion_WS_084(i,31) = confusion_WS_084(i,mod(i-1,30)+1)/sum(confusion_WS_084(i,1:30))*100;
end
 
class_acc_WS_084 = reshape(confusion_WS_084(:,31),30,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_105,1)    
    confusion_WS_105(i,31) = confusion_WS_105(i,mod(i-1,30)+1)/sum(confusion_WS_105(i,1:30))*100;
end
 
class_acc_WS_105 = reshape(confusion_WS_105(:,31),30,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_126,1)    
    confusion_WS_126(i,31) = confusion_WS_126(i,mod(i-1,30)+1)/sum(confusion_WS_126(i,1:30))*100;
end
 
class_acc_WS_126 = reshape(confusion_WS_126(:,31),30,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_147,1)    
    confusion_WS_147(i,31) = confusion_WS_147(i,mod(i-1,30)+1)/sum(confusion_WS_147(i,1:30))*100;
end
 
class_acc_WS_147 = reshape(confusion_WS_147(:,31),30,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_167,1)    
    confusion_WS_167(i,31) = confusion_WS_167(i,mod(i-1,30)+1)/sum(confusion_WS_167(i,1:30))*100;
end
 
class_acc_WS_167 = reshape(confusion_WS_167(:,31),30,10); % row:action class, coulmn:motion_diff
