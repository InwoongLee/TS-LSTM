...
for i=1:size(confusion_WS_030,1)    
    confusion_WS_030(i,61) = confusion_WS_030(i,mod(i-1,60)+1)/sum(confusion_WS_030(i,1:60))*100;
end
 
class_acc_WS_030 = reshape(confusion_WS_030(:,61),60,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_060,1)    
    confusion_WS_060(i,61) = confusion_WS_060(i,mod(i-1,60)+1)/sum(confusion_WS_060(i,1:60))*100;
end
 
class_acc_WS_060 = reshape(confusion_WS_060(:,61),60,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_090,1)    
    confusion_WS_090(i,61) = confusion_WS_090(i,mod(i-1,60)+1)/sum(confusion_WS_090(i,1:60))*100;
end
 
class_acc_WS_090 = reshape(confusion_WS_090(:,61),60,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_120,1)    
    confusion_WS_120(i,61) = confusion_WS_120(i,mod(i-1,60)+1)/sum(confusion_WS_120(i,1:60))*100;
end
 
class_acc_WS_120 = reshape(confusion_WS_120(:,61),60,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_150,1)    
    confusion_WS_150(i,61) = confusion_WS_150(i,mod(i-1,60)+1)/sum(confusion_WS_150(i,1:60))*100;
end
 
class_acc_WS_150 = reshape(confusion_WS_150(:,61),60,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_180,1)    
    confusion_WS_180(i,61) = confusion_WS_180(i,mod(i-1,60)+1)/sum(confusion_WS_180(i,1:60))*100;
end
 
class_acc_WS_180 = reshape(confusion_WS_180(:,61),60,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_210,1)    
    confusion_WS_210(i,61) = confusion_WS_210(i,mod(i-1,60)+1)/sum(confusion_WS_210(i,1:60))*100;
end
 
class_acc_WS_210 = reshape(confusion_WS_210(:,61),60,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_240,1)    
    confusion_WS_240(i,61) = confusion_WS_240(i,mod(i-1,60)+1)/sum(confusion_WS_240(i,1:60))*100;
end
 
class_acc_WS_240 = reshape(confusion_WS_240(:,61),60,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_270,1)    
    confusion_WS_270(i,61) = confusion_WS_270(i,mod(i-1,60)+1)/sum(confusion_WS_270(i,1:60))*100;
end
 
class_acc_WS_270 = reshape(confusion_WS_270(:,61),60,10); % row:action class, coulmn:motion_diff
...
for i=1:size(confusion_WS_300,1)    
    confusion_WS_300(i,61) = confusion_WS_300(i,mod(i-1,60)+1)/sum(confusion_WS_300(i,1:60))*100;
end
 
class_acc_WS_300 = reshape(confusion_WS_300(:,61),60,10); % row:action class, coulmn:motion_diff
